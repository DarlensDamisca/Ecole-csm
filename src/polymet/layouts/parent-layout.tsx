...
const navItems: NavItem[] = [
  { label: "Dashboard", href: "/parent/dashboard", icon: LayoutDashboardIcon },
  { label: "Notes de mon enfant", href: "/parent/grades", icon: FileTextIcon },
  { label: "Bulletins", href: "/parent/reports", icon: DownloadIcon },
]
          ...
          <div className="p-4 border-t border-[#bebbb4]">
            <div className="flex items-center gap-3 px-4 py-3 bg-[#f7f7f6] rounded-lg">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-xs text-[#5b6d77] truncate">Parent</p>
              </div>
            </div>
          </div>
        </div>
