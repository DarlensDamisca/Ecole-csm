...
const navItems: NavItem[] = [
  { label: "Dashboard", href: "/student/dashboard", icon: LayoutDashboardIcon },
  { label: "Mes Notes", href: "/student/grades", icon: FileTextIcon },
  { label: "Mes Bulletins", href: "/student/reports", icon: DownloadIcon },
]
          ...
          <div className="p-4 border-t border-[#bebbb4]">
            <div className="flex items-center gap-3 px-4 py-3 bg-[#f7f7f6] rounded-lg">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-xs text-[#5b6d77] truncate">Élève</p>
              </div>
            </div>
          </div>
        </div>
