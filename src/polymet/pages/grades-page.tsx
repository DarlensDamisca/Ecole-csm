...
import { grades, students, subjectParents, subjectChildren, periods, levels, academicYears, classrooms, attitudes, studentBehaviors, type Attitude } from "@/polymet/data/school-data"
import { AlertTriangleIcon } from "lucide-react"

export function GradesPage() {
  const { yearId = 'ay-2024' } = useParams()
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
        ...
        <TabsContent value="notes">
          <CPMSLGradesGrid
            ...
            onClosePeriod={(periodId, reason) => {
              toast({ 
                title: "Étape clôturée", 
                description: "L'étape a été clôturée." 
              })
            }}
          />
        </TabsContent>
        ...
        <TabsContent value="comportement">
          <CPMSLBehaviorGrid
            ...
            isArchived={isArchived}
            onSaveBehaviors={(behaviors) => {
              toast({ title: "Comportements enregistrés", description: "Les évaluations de comportement ont été sauvegardées." })
            }}
