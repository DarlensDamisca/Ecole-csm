...
import type { Level, Classroom, Period, Student, SubjectParent, SubjectChild, Grade } from "@/polymet/data/school-data"
    ...
    return classrooms.map(classroom => {
      ...
      if (studentsInClassroom.length === 0) {
        return {
          ...
          levelOrder: levels.find(l => l.id === classroom.levelId)?.order || 0,
          totalExpected: 0,
          totalEntered: 0,
          percentage: 0
        }
